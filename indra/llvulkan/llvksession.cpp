...
namespace
{
    ...
    // Match the ordinary GL login clear (transparent black).
    const float kClearR = 0.0f, kClearG = 0.0f, kClearB = 0.0f, kClearA = 0.0f;
...
void LLVKSession::renderUIFrame(LLView* root, float ui_scale_x, float ui_scale_y)
{
    ...
    // Begin the 2D render pass with the normal transparent-black clear.
